...
function library:NewWindow(porn,hub)
    ...
    --<<<  Make Connection 
    tween:Create(MainWindow,TweenInfo.new(0.4,Enum.EasingStyle.Back),{Size = UDim2.new(0, 440, 0, 200)}):Play()
    dragify(MainWindow)
...
local a = library:NewWindow("Alter","Hub") 
local b = a:NewSection("Welcome")
b:Text("Loading")
wait(1)
game:GetService("CoreGui").ScreenGui.MainWindow.Pages.Welcome.TextA:Destroy()
b:Text("Checking Compatibility...")
wait(0.5)
game:GetService("CoreGui").ScreenGui.MainWindow.Pages.Welcome.TextA:Destroy()
b:Text("Setting Up Resources...")
wait(0.5)
game:GetService("CoreGui").ScreenGui.MainWindow.Pages.Welcome.TextA:Destroy()
b:Text("Exploiting Vulnerabilities...")
wait(0.5)
game:GetService("CoreGui").ScreenGui.MainWindow.Pages.Welcome.TextA:Destroy()
b:Text("Welcome To")
wait(1)
